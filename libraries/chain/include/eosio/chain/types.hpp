...
namespace eosio { namespace chain {
   ...
   enum object_type
   {
      ...
      // delete UNUSED_obj_type_for_eosio_upgrade_XX when eosio add obj type

      // for eosio update obj type delete when eosio add obj type
      UNUSED_obj_type_for_eosio_upgrade_00,
      UNUSED_obj_type_for_eosio_upgrade_01,
      UNUSED_obj_type_for_eosio_upgrade_02,
      UNUSED_obj_type_for_eosio_upgrade_03,
      UNUSED_obj_type_for_eosio_upgrade_04,
      UNUSED_obj_type_for_eosio_upgrade_05,
      UNUSED_obj_type_for_eosio_upgrade_06,
      UNUSED_obj_type_for_eosio_upgrade_07,
      UNUSED_obj_type_for_eosio_upgrade_08,
      UNUSED_obj_type_for_eosio_upgrade_09,
      UNUSED_obj_type_for_eosio_upgrade_10,
      UNUSED_obj_type_for_eosio_upgrade_11,
      UNUSED_obj_type_for_eosio_upgrade_12,
      UNUSED_obj_type_for_eosio_upgrade_13,
      UNUSED_obj_type_for_eosio_upgrade_14,
      UNUSED_obj_type_for_eosio_upgrade_15,
      UNUSED_obj_type_for_eosio_upgrade_16,
      UNUSED_obj_type_for_eosio_upgrade_17,
      UNUSED_obj_type_for_eosio_upgrade_18,
      UNUSED_obj_type_for_eosio_upgrade_19,
      UNUSED_obj_type_for_eosio_upgrade_20,
      UNUSED_obj_type_for_eosio_upgrade_21,
      UNUSED_obj_type_for_eosio_upgrade_22,
      UNUSED_obj_type_for_eosio_upgrade_23,
      UNUSED_obj_type_for_eosio_upgrade_24,
      UNUSED_obj_type_for_eosio_upgrade_25,
      UNUSED_obj_type_for_eosio_upgrade_26,
      UNUSED_obj_type_for_eosio_upgrade_27,
      UNUSED_obj_type_for_eosio_upgrade_28,
      UNUSED_obj_type_for_eosio_upgrade_29,
      UNUSED_obj_type_for_eosio_upgrade_30,
      UNUSED_obj_type_for_eosio_upgrade_31,
      UNUSED_obj_type_for_eosio_upgrade_32,
      UNUSED_obj_type_for_eosio_upgrade_33,
      UNUSED_obj_type_for_eosio_upgrade_34,
      UNUSED_obj_type_for_eosio_upgrade_35,
      UNUSED_obj_type_for_eosio_upgrade_36,
      UNUSED_obj_type_for_eosio_upgrade_37,
      UNUSED_obj_type_for_eosio_upgrade_38,
      UNUSED_obj_type_for_eosio_upgrade_39,
      UNUSED_obj_type_for_eosio_upgrade_40,
      UNUSED_obj_type_for_eosio_upgrade_41,
      UNUSED_obj_type_for_eosio_upgrade_42,
      UNUSED_obj_type_for_eosio_upgrade_43,
      UNUSED_obj_type_for_eosio_upgrade_44,
      UNUSED_obj_type_for_eosio_upgrade_45,
      UNUSED_obj_type_for_eosio_upgrade_46,
      UNUSED_obj_type_for_eosio_upgrade_47,
      UNUSED_obj_type_for_eosio_upgrade_48,
      UNUSED_obj_type_for_eosio_upgrade_49,
      UNUSED_obj_type_for_eosio_upgrade_50,
      UNUSED_obj_type_for_eosio_upgrade_51,
      UNUSED_obj_type_for_eosio_upgrade_52,
      UNUSED_obj_type_for_eosio_upgrade_53,
      UNUSED_obj_type_for_eosio_upgrade_54,
      UNUSED_obj_type_for_eosio_upgrade_55,
      UNUSED_obj_type_for_eosio_upgrade_56,
      UNUSED_obj_type_for_eosio_upgrade_57,
      UNUSED_obj_type_for_eosio_upgrade_58,
      UNUSED_obj_type_for_eosio_upgrade_59,
      UNUSED_obj_type_for_eosio_upgrade_60,
      UNUSED_obj_type_for_eosio_upgrade_61,
      UNUSED_obj_type_for_eosio_upgrade_62,
      UNUSED_obj_type_for_eosio_upgrade_63,
      // obj type for codex.io, delete when eosio add obj type
